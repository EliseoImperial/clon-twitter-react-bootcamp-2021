...
const Sidebar = () => {
  return (
    <div>
      <div className="col-md-3 col-xs-2  columna-izquierda">
        ...
        <ul className="mt-2 list-goup">
          <li className="list-group-item list-group-item-action border-0 p-3 fs-6 fw-bold hover">
            <a className={styles.aLineColor} href="/home">
              <span>
          ...
          <li className="list-group-item list-group-item-action border-0 p-3 fs-6 fw-bold hover">
            <a className={styles.aLineColor} href="...">
              <span>
          ...
          <li className="list-group-item list-group-item-action border-0 p-3 fs-6 fw-bold hover">
            <a className={styles.aLineColor} href="/perfil/<%=user.username%>">
              <span>
